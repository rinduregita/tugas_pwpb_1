...
<br>
  ...
  <!-- Three columns of text below the carousel -->
    <div class="row">
      <div class="col-lg-4">  
      <img src="rindu.jpg" style="border-radius: 50%" width="150px" height="150px">
        <ul>
      ...
      <div class="col-lg-4">
        <img src="nabila.jpg" style="border-radius: 50%" width="150px" height="150px">
      <ul>
      ...
      <div class="col-lg-4">
        <img src="zidan.jpg" style="border-radius: 50%" width="150px" height="150px">
      <ul>
