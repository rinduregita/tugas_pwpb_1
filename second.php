  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link disabled" href="#">Third</a>
        </li>
      </ul>
...
<br>
  ...
  <!-- Three columns of text below the carousel -->
    <div class="row">
      <div class="col-lg-4">  
      <img src="rindu.jpg" style="border-radius: 50%" width="150px" height="200px">
        <ul>
      ...
      <div class="col-lg-4">
        <img src="nabila.jpg" style="border-radius: 50%" width="150px" height="200px">
      <ul>
      ...
      <div class="col-lg-4">
        <img src="zidan.jpg" style="border-radius: 50%" width="150px" height="200px">
      <ul>
